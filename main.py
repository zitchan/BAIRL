...
if __name__ == '__main__':
    ...
    env = VecNormalize(env, gamma= 0.95, norm_obs=True, norm_reward=False)
    ...
    expert = PPO.load("./model/expert/ppo-halfcheetah-v5.zip")
    ...
    # learner.learn(total_timesteps=1000000)
    env.seed(SEED)
    learner_rewards_before_training, _ = evaluate_policy(
        learner, env, 100, return_episode_rewards=True,
    )
    # learner.save("./model/expert/ppo-halfcheetah-v5.zip")
    ...
    # learner.save("./model/airl/model/halfcheetah_bairl.zip")
    # torch.save(reward_net, "model/airl/model/reward_net_airl128.pth")
    # learner = PPO.load("model/airl/model/ant_airl_dropout.zip")
    # env.seed(SEED)
